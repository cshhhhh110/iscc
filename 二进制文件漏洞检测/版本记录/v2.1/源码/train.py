"""v2.1 training: homogeneous emb=48 + self-attention + SWA (no augmentation)."""
...
def main():
    ...
    seeds = args.seeds
    print(f"v2.1 ensemble training: seeds={seeds}, device={DEVICE}")
    ...
    for seed in seeds:
        ...
        torch.save({
            ...
            "byte_length": int(args.byte_length), "metrics": neural_metrics, "model_version": "v2.1", "seed": seed,
    ...
    joblib.dump({
        ...
        "model_version": "v2.1", "label_model_files": {s: seed_label_model(s) for s in seeds},
