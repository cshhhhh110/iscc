"""Prediction entrypoint for v2.1: weighted ensemble + scalar fusion + TTA."""
...
def main():
    ...
    print(f"v2.1 prediction: fusion_mode={fusion_mode}, seeds={seeds}, tta={use_tta}({tta_windows} windows)")
