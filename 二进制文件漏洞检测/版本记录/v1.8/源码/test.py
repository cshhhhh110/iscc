"""Prediction entrypoint for v1.8: weighted ensemble + scalar fusion + TTA."""
...
def main():
    ...
    print(f"v1.8 prediction: fusion_mode={fusion_mode}, seeds={seeds}, tta={use_tta}({tta_windows} windows)")
