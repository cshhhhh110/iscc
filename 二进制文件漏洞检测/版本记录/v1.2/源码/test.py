"""Prediction entrypoint for the ISCC binary vulnerability v1.2 pipeline."""
...
def _report_submission_delta(output_csv: Path) -> None:
    previous_csv = OUTPUT_DIR / "submission_v1.1.csv"
    if not previous_csv.exists() or not output_csv.exists():
        return
