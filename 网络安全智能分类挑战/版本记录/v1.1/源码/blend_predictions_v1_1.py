...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description=f"Blend GPU FT-Transformer and sklearn predictions for {VERSION}.")
    ...
    parser.add_argument(
        "--gpu-probs-path",
        type=Path,
        default=root / "\u6a21\u578b" / f"gpu_fttransformer_test_probs_{VERSION}.npy",
    )
    parser.add_argument(
        "--gpu-model-path",
        type=Path,
    ...
    parser.add_argument(
        "--sklearn-probs-path",
        type=Path,
        default=root / "\u6a21\u578b" / "sklearn_test_probs.npy",
    )
    parser.add_argument(
        "--sklearn-model-path",
        type=Path,
        default=root / "\u6a21\u578b" / "model_bundle.joblib",
    )
    parser.add_argument(
        "--output-path",
        type=Path,
    ...
    parser.add_argument("--gpu-weight", type=float, default=0.65)
    parser.add_argument("--sklearn-weight", type=float, default=0.35)
